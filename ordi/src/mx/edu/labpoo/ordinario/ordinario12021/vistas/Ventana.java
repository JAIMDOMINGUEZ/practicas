...
public class Ventana extends JFrame{ //hereda de JFrame (A)
    ...
    private void initComponents() {
        ...
        btnAdd.addActionListener(new ActionListener(){
            public void btnAddActionPerformed(ActionEvent o){
                btnAddActionPerformed(o);
            }
            }); 
        ...
        mnuSave.addActionListener(new ActionListener(){
            public void mnuSaveActionPerformed(ActionEvent o){
        ...
        mnuSave.addActionListener(new ActionListener(){
            public void mnuExitActionPerformed(ActionEvent o){
